...
Thank you for your interest in contributing to Phone Input Bundle! This document provides guidelines for contributing to the project.
...
1. **Check that the bug hasn't already been reported** in the [issues](https://github.com/nowo-tech/PhoneInputBundle/issues)
...
1. **Check that the enhancement hasn't already been suggested** in the [issues](https://github.com/nowo-tech/PhoneInputBundle/issues)
2. **Create a new issue** with:
   - A descriptive title
...
- **PHP 8.2+**: `readonly` classes and other PHP 8.2 features
...
Thank you for contributing to Phone Input Bundle. Your help makes this project better for everyone.
